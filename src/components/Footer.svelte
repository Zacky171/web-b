...
>
    ...
    <div class="flex flex-col gap-4 items-center justify-center">
        ...
        <p><b class="pr-2">Email</b> mmuzackyr9@gmail.com</p>
        <p>
            <b class="pr-2">instagram</b>
            <a href="https://www.instagram.com/zacky.rsnd/" target="_blank" class="text-violet-400"
                >@zacky.rsnd<sup class=""
        ...
        <p>
            ...
            <a href="https://www.linkedin.com/in/m-muzacky-riswanda-689181269/" target="_blank" class="text-violet-400"
                >M Muzacky Riswanda<sup class=""
                    ><span class="text-xs scale-75 pl-0.5"
                        ><i
                            class="fa-solid fa-arrow-up-right-from-square text-xs scale-[75%]"
                        /></span
